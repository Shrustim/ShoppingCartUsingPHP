...
<a href="index.php"style="margin-left:20px;color:#000000">Registration</a>
</div>

<h1 align="center" c style="text-shadow:5px 5px 9px yellow; color:#FFFFFF">Registration</h1> 
<center>
<div style="background:#001e2d; height:700px; width:500px; color:#FFFFFF">
     <br/>
    <form  action="reg.php" method="POST">
	  ...
	  <div>
	      <h4> Address :</h4>
	       <input type="text" name="add" size="40" maxlength="40"  />
      </div>
	  <div>
	      <h4> Email :</h4>
	   ...
	   <div>
	      <h4> Mobile No :</h4>
	       <input type="text" name="mobileno" size="40" maxlength="10"  />
      </div>
      <div >
	  	     <h4>Password :</h4>
