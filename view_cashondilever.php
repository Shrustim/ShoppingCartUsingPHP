...
<h1 align="center"  style="text-shadow:5px 5px 9px yellow; color:#FFFFFF"> View Orders of CashOnDelivery</h1> 
<?php 
$query="SELECT * FROM  `cashondelivar` ";
...
<td><a href='deletecashondeliver.php?id=$result[id]' onclick='return checkdelete()'>Delete</a></td>
