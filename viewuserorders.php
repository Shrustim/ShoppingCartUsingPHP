...
<h1 align="center"  style="text-shadow:5px 5px 9px yellow; color:#FFFFFF; color:#FFFFFF">View Orders</h1>

<?php 
$query="SELECT * FROM  `creditorders` WHERE email='$email' ";
         
  $data=mysqli_query($conn,$query);

$query1="SELECT * FROM  `debitorders` WHERE email='$email' ";
