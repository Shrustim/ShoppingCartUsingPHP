...
<title>Payment Option Debit Card</title>
<style type="text/css">
  body{
  margin:0;
  padding:0;
...
<h1 align="center"  style="text-shadow:5px 5px 9px yellow; color:#FFFFFF; color:#FFFFFF">Payment Option Debit Card</h1>
...
<form action="debit2.php" method="post">
...
Card No:<input type="text" size="40" maxlength="16" name="cardno" value="" /><br/><br/>
CardHolder:<input type="text" size="40" maxlength="50" name="cardholder" value=""  /><br/><br/>
Cvv: <input type="text" size="40" maxlength="15" name="cvv" value="" /><br/><br/>
Expire Date (yyyy-mm-dd):<input placeholder="yyyy-mm-dd" type="text" size="40" maxlength="50" name="expiredate" value="" /> <br/><br/>
